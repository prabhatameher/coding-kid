...
import leftChart from '../images/leftChat.svg'
        ...
        <>
            <Box display='flex'>
                ...
                <Box display='flex' style={{ display: 'inline', textAlign: 'center', position: 'relative' }}>
                    <img src={leftChart} alt='chat' width='440px' height='187px' />
                    <Box display='flex' flexDirection='column' textAlign='left' style={{ position: 'absolute', top: 30, marginLeft: '60px' }}>
                        <Box>
